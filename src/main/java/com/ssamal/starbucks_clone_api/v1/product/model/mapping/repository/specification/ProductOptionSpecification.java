package com.ssamal.starbucks_clone_api.v1.product.model.mapping.repository.specification;
...
public class ProductOptionSpecification {
    ...
    public static Specification<ProductOptions> lessThanPrice(Integer price) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.lessThanOrEqualTo(root.get("product").get("price"), price);
    }
