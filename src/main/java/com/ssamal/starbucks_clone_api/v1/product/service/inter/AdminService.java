...
public interface AdminService {
    ...
    List<ProdAdminRes.AddMenuRes> addSeason(List<ProdAdminReq.AddSeason> req);
    ProdAdminRes.AddProductToMenuRes addProductToSeason(ProdAdminReq.AddProductTo req);
